...
class Main {
    ...
    public static void main(String[] args) {
        ...
        //XML в JSON
        //Чтение файла
        List<Employee> employees2 = parseXML("D://new_life//JAVA//IDEA//CSV_to_JSON_MAVEN//data.xml");
        // Конвертация в  JSON
        String json2 = listToJson(employees2);
        //Запись на диск
        writeString(json2, "D://new_life//JAVA//IDEA//CSV_to_JSON_MAVEN//employees2.json");
